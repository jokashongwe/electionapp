...
class Person
{
    ...
    public function getBarrau(): ?string
    {
        return $this->barrau;
    }

    public function setBarrau(string $barrau): static
    {
        $this->barrau = $barrau;
